...
| `POSTURERMM_DOMAIN` | `localhost` | Hostname agents and browsers use to reach this server. A DNS name or a bare IP. Drives the certificate the server generates and the URL baked into agent install commands. |
